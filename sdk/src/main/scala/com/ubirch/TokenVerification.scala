...
@Singleton
class DefaultTokenVerification @Inject() (config: Config, tokenPublicKey: TokenPublicKey, jsonConverterService: DefaultJsonConverterService) extends TokenVerification with LazyLogging {
